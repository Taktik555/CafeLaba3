...
Window {
    ...
    Button {
        ...
        width: 100
        onClicked: {
            var nameRiv = rivList.currentItem.riverData.nameOfCafe
            var lenghtRiv = rivList.currentItem.riverData.lenghtOfCafe
            var flowRiv = rivList.currentItem.riverData.flowOfCafe
            var runoffRiv = rivList.currentItem.riverData.runoffOfCafe
    ...
    Button {
        ...
        Button {
            ...
            onClicked: windowAnswer.countCafes(textSelArea.text)
        }
